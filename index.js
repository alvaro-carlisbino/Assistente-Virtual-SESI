...
manager.addAnswer('pt', 'teams', `O Microsoft Teams é uma plataforma de comunicação, que pode ser usada para comunicar-se  com colegas de trabalho, amigos e familiares. Para ser utilizado, siga estas etapas:
...
manager.addAnswer('pt', 'powerpoint', `Para começar a usar o PowerPoint, siga os seguintes passos:
...
manager.addAnswer('pt', 'ava', `O AVA, que significa Ambiente Virtual de Aprendizagem, é uma plataforma online que permite a realização de atividades acadêmicas e o acompanhamento do progresso do estudante em um curso ou disciplina
...
manager.addAnswer('pt', 'office', `O Office 365 é uma suíte de aplicativos de produtividade da Microsoft que oferece uma variedade de ferramentas para criação e edição de documentos, planilhas, apresentações e muito mais. Para usar o Office 365, siga as instruções abaixo:
...
manager.addAnswer('pt', 'codigo-fonte', `O meu código fonte está disponível no meu github:
