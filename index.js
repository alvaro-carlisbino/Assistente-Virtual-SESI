...
manager.addDocument('pt', 'Como faço para acessar o portal do aluno do sesi', 'portal');
manager.addDocument('pt', "Como posso fazer para usar o canva", "canva");
manager.addDocument('pt', 'Alvaro', 'alvaro');
manager.addAnswer('pt', 'alvaro', 'Alvaro é o melhor professor de todos os tempos, ele é muito legal e sabe tudo sobre programação.');
...
manager.addAnswer('pt', 'portal', 'Para acessar o portal do aluno, basta acessar o link: https://portal.sesi.org.br/');
manager.addAnswer('pt', 'canva', 'Para utilizar o Canva, basta acessar o site ou baixar o aplicativo, criar uma conta ou fazer login, e escolher um modelo ou começar um projeto do zero utilizando as ferramentas disponíveis na plataforma.');
...
manager.addDocument('pt', 'Como faço para ver minhas notas no portal do aluno?', 'notas');
manager.addDocument('pt', 'Onde posso encontrar minhas notas no portal do aluno?', 'notas');
manager.addDocument('pt', 'Qual é o procedimento para acessar minhas notas no portal do aluno?', 'notas');
manager.addAnswer('pt', 'notas', 'Para ver suas notas no portal do aluno do SESI, faça login na plataforma com suas credenciais e clique na opção "Notas" no menu lateral. Lá você encontrará todas as suas notas e o histórico de desempenho nas disciplinas.');

manager.addDocument('pt', 'Como posso ver minha grade de horário no portal do aluno?', 'horario');
manager.addDocument('pt', 'Onde encontro minha grade de horário no portal do aluno?', 'horario');
manager.addDocument('pt', 'Qual é o procedimento para acessar minha grade de horário no portal do aluno?', 'horario');
manager.addAnswer('pt', 'horario', 'Para ver sua grade de horário no portal do aluno do SESI, faça login na plataforma com suas credenciais e clique na opção "Grade Horária" no menu lateral. Lá você encontrará todas as informações sobre seus horários de aula, turmas e disciplinas.');

manager.addDocument('pt', 'O que é uma incubadora de startups?', 'incubadora');
manager.addDocument('pt', 'Como funciona uma incubadora de startups?', 'incubadora');
manager.addDocument('pt', 'Quais são os benefícios de participar de uma incubadora de startups?', 'incubadora');
